...
class KbApiMixin:
    ...
    @Tool(
        "knowledge_search",
        description=(
            "检索本地知识库（原神/游戏/小说世界观等已导入的文档）。"
            "当用户询问世界观、剧情、角色、设定相关问题时调用。\n\n"
            "提示：构造 query 时尽量把相关的角色名/地名/事件一起塞进去，能显著提高召回质量。"
            "例如用户问'你认识哥伦比娅吗'，不要只搜'哥伦比娅'，"
            "而应把你自己（桑多涅）也加上一起搜'哥伦比娅 桑多涅'，"
            "这样能命中讨论你们两人关系的段落。"
        ),
        ...
        parameters=[
            ToolParameterInfo(
                ...
                description=(
                    "检索查询。建议把多个相关实体一起塞进来提升召回率，"
                    "例如用户问'你认识哥伦比娅吗'时搜 '哥伦比娅 桑多涅' 而非只搜 '哥伦比娅'；"
                    "问'蒙德发生过什么'时搜 '蒙德 风魔龙 温迪' 而非只搜 '蒙德'。"
                    "也可以是完整问题，如 '法涅斯是谁' 或 '提瓦特七国'。"
                ),
                required=True,
            ),
            ToolParameterInfo(
